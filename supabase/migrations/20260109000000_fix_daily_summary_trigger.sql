-- ============================================================================
-- StrengthWise Migration: 038_fix_daily_summary_trigger.sql
-- ============================================================================
-- 建立時間：2026-01-09
-- 目標：修復 daily_workout_summary 觸發器，恢復基於 set.completed 的正確統計
-- ============================================================================
...
-- ============================================================================
-- 2. 創建新的觸發器函數（基於 set.completed 統計）
-- ============================================================================
...
BEGIN
  ...
  -- ⭐ 重新聚合該日期的所有訓練數據（基於 set.completed）
...
INSERT INTO daily_workout_summary (
  user_id, date, workout_count, completed_workout_count, partial_workout_count,
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE '====================================================================';
  RAISE NOTICE '✅ Migration 038 完成：daily_workout_summary 觸發器修復';
  RAISE NOTICE '====================================================================';
  RAISE NOTICE '  ✓ 已生成 % 筆日期彙總記錄', record_count;
  RAISE NOTICE '';
END $$;
