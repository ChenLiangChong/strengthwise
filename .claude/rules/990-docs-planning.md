...
└── archived/                       ← 📦 已完成的規格書（13 個）
    ├── EXERCISE_CLASSIFICATION_ANALYSIS.md ← v5.0 動作分類系統（775 筆）✅
    ├── EXERCISE_CLASSIFICATION_DISCUSSIONS.md ← v5.0 分類討論紀錄 ✅
    ├── V5_IMPACT_ANALYSIS.md       ← v5.0 全面影響分析 ✅
