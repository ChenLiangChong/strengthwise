...
class DrawingServiceSupabase implements IDrawingService {
  ...
  DrawingServiceSupabase(this._supabase, this._errorService);
      ...
      for (final element in visualElements) {
        if (element['type'] == 'drawing' && element['drawing_data'] != null) {
          ...
          if (templateType != null &&
              element['template_type'] != templateType) {
            continue;
          }
          ...
          final correctedDrawing =
              drawing.copyWith(sessionNoteId: sessionNoteId);
          debugPrint(
